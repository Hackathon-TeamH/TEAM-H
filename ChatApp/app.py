...
def channel(channel_id):
    ...
    return render_template('chat.html', user_id=user_id, channel_id=channel_id, channel_name=channel_name, users_num=users_num, channels=channels, messages=messages)
